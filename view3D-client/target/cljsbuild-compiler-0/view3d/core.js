...
var pitch = (function (){var pred__12378 = cljs.core._EQ_;
var expr__12379 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,view3d.core.camera));
if(cljs.core.truth_(pred__12378.call(null,"UP",expr__12379))){
return (90);
} else {
if(cljs.core.truth_(pred__12378.call(null,"DOWN",expr__12379))){
return (-90);
} else {
...
var head = view3d.core.norm_crs.call(null,(function (){var pred__12381 = cljs.core._EQ_;
var expr__12382 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,view3d.core.camera));
if(cljs.core.truth_(pred__12381.call(null,"ASTERN",expr__12382))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__12381.call(null,"STARBOARD",expr__12382))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__12381.call(null,"PORT",expr__12382))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__12381.call(null,"STAR-BOW",expr__12382))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__12381.call(null,"PORT-BOW",expr__12382))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__12381.call(null,"STAR-ABAFT",expr__12382))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__12381.call(null,"PORT-ABAFT",expr__12382))){
return (crs - (135));
} else {
return crs;
}
...
var vec__12385 = new cljs.core.Keyword(null,"coord","coord",-1453656639).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,view3d.core.boat));
var lat = cljs.core.nth.call(null,vec__12385,(0),null);
var lon = cljs.core.nth.call(null,vec__12385,(1),null);
...
view3d.core.error_handler = (function view3d$core$error_handler(p__12386){
var map__12389 = p__12386;
...
var status = cljs.core.get.call(null,map__12389__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.call(null,map__12389__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
view3d.core.clear_selectors = (function view3d$core$clear_selectors(){
view3d.core.set_html_BANG_.call(null,"element2","");

view3d.core.set_html_BANG_.call(null,"element3","");

return view3d.core.set_html_BANG_.call(null,"element4","");
});
view3d.core.clear_selectors34 = (function view3d$core$clear_selectors34(){
view3d.core.set_html_BANG_.call(null,"element3","");
...
view3d.core.handler4 = (function view3d$core$handler4(selected){
return view3d.core.function4.call(null,selected);
});
view3d.core.display_answer = (function view3d$core$display_answer(answer){
var dis_12514 = view3d.core.get_html.call(null,"display");
if(!(cljs.core.empty_QMARK_.call(null,dis_12514))){
view3d.core.set_html_BANG_.call(null,"display2",dis_12514);
} else {
}
...
view3d.core.get_answer_and_ask = (function view3d$core$get_answer_and_ask(handler){
return (function (){
return view3d.core.ask_server.call(null,view3d.core.ANS_PTH,null,new cljs.core.Keyword(null,"transit","transit",359458387),handler);
});
});
...
view3d.core.FST_ANS = "";
view3d.core.display_both_answers = (function view3d$core$display_both_answers(second_ans){
view3d.core.set_html_BANG_.call(null,"display2",view3d.core.get_html.call(null,"display"));

return view3d.core.set_html_BANG_.call(null,"display",[cljs.core.str(view3d.core.FST_ANS),cljs.core.str("<br><br>"),cljs.core.str(second_ans)].join(''));
});
view3d.core.retrieve_second = (function view3d$core$retrieve_second(first_ans){
view3d.core.FST_ANS = first_ans;

return view3d.core.ask_server.call(null,view3d.core.ANS_PTH,null,new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.display_both_answers);
});
view3d.core.retrieve_2_answers = (function view3d$core$retrieve_2_answers(){
return view3d.core.ask_server.call(null,view3d.core.ANS_PTH,null,new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.retrieve_second);
});
...
view3d.core.function4 = (function view3d$core$where_object_$_function4(a){
return view3d.core.ask_server.call(null,view3d.core.QST_PTH,cljs.core.merge.call(null,cljs.core.deref.call(null,view3d.core.boat),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"predicate","predicate",-1742501860),"where-is",new cljs.core.Keyword(null,"subject","subject",-1411880451),view3d.core.SBJECT,new cljs.core.Keyword(null,"subject-value","subject-value",-1557312678),a], null)),new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.retrieve_answer);
});
});
view3d.core.where_type = (function view3d$core$where_type(types){
view3d.core.selector3.call(null,"?",types,new cljs.core.Keyword(null,"itself","itself",1264932322));

view3d.core.function3 = (function view3d$core$where_type_$_function3(a){
view3d.core.set_html_BANG_.call(null,"element4","");
...
view3d.core.selector2.call(null,"?",things,new cljs.core.Keyword(null,"itself","itself",1264932322));

view3d.core.function2 = (function view3d$core$about_thing_$_function2(a){
return view3d.core.ask_server.call(null,view3d.core.QST_PTH,cljs.core.merge.call(null,cljs.core.deref.call(null,view3d.core.boat),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"predicate","predicate",-1742501860),"about",new cljs.core.Keyword(null,"subject","subject",-1411880451),"thing",new cljs.core.Keyword(null,"subject-value","subject-value",-1557312678),a], null)),new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.retrieve_answer);
});
});
view3d.core.where_thing = (function view3d$core$where_thing(things){
view3d.core.selector3.call(null,"?",things,new cljs.core.Keyword(null,"itself","itself",1264932322));

view3d.core.function3 = (function view3d$core$where_thing_$_function3(a){
return view3d.core.ask_server.call(null,view3d.core.QST_PTH,cljs.core.merge.call(null,cljs.core.deref.call(null,view3d.core.boat),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"predicate","predicate",-1742501860),"where-is",new cljs.core.Keyword(null,"subject","subject",-1411880451),"thing",new cljs.core.Keyword(null,"subject-value","subject-value",-1557312678),a], null)),new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.retrieve_answer);
});
});
...
var pred__12524 = cljs.core._GT__EQ_;
var expr__12525 = n;
if(cljs.core.truth_(pred__12524.call(null,(7),expr__12525))){
...
view3d.core.lst2 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["island","object","interesting thing"], null);
...
var n = cljs.reader.read_string.call(null,a);
var pred__12536 = cljs.core._GT__EQ_;
var expr__12537 = n;
if(cljs.core.truth_(pred__12536.call(null,(0),expr__12537))){
return view3d.core.ask_server.call(null,view3d.core.QST_PTH,cljs.core.merge.call(null,cljs.core.deref.call(null,view3d.core.boat),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"predicate","predicate",-1742501860),"nearby-islands"], null)),new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.get_answer_and_ask.call(null,view3d.core.where_island));
} else {
if(cljs.core.truth_(pred__12536.call(null,(1),expr__12537))){
return view3d.core.ask_server.call(null,view3d.core.QST_PTH,cljs.core.merge.call(null,cljs.core.deref.call(null,view3d.core.boat),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"predicate","predicate",-1742501860),"nearby-types"], null)),new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.get_answer_and_ask.call(null,view3d.core.where_type));
} else {
if(cljs.core.truth_(pred__12536.call(null,(2),expr__12537))){
return view3d.core.ask_server.call(null,view3d.core.QST_PTH,cljs.core.merge.call(null,cljs.core.deref.call(null,view3d.core.boat),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"predicate","predicate",-1742501860),"nearby-things"], null)),new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.get_answer_and_ask.call(null,view3d.core.where_thing));
} else {
...
var n = cljs.reader.read_string.call(null,a);
var pred__12548 = cljs.core._GT__EQ_;
var expr__12549 = n;
if(cljs.core.truth_(pred__12548.call(null,(0),expr__12549))){
return view3d.core.ask_server.call(null,view3d.core.QST_PTH,cljs.core.merge.call(null,cljs.core.deref.call(null,view3d.core.boat),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"predicate","predicate",-1742501860),"nearby-islands"], null)),new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.get_answer_and_ask.call(null,view3d.core.about_island));
} else {
if(cljs.core.truth_(pred__12548.call(null,(1),expr__12549))){
...
view3d.core.what_interesting = (function view3d$core$what_interesting(){
return view3d.core.ask_server.call(null,view3d.core.QST_PTH,cljs.core.merge.call(null,cljs.core.deref.call(null,view3d.core.boat),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"predicate","predicate",-1742501860),"what",new cljs.core.Keyword(null,"subject","subject",-1411880451),"interesting"], null)),new cljs.core.Keyword(null,"transit","transit",359458387),view3d.core.get_answer_and_ask.call(null,view3d.core.about_thing));
});
...
view3d.core.selector1.call(null,"?",new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, ["What is","Where is","Tell me more about","What about nearby interesting things?","What is the weather?","Clear HUD"], null),new cljs.core.Keyword(null,"count","count",2139924085));

view3d.core.clear_hud = (function view3d$core$questionnaire_$_clear_hud(){
view3d.core.set_html_BANG_.call(null,"display","");

return view3d.core.set_html_BANG_.call(null,"display2","");
});

view3d.core.function1 = (function view3d$core$questionnaire_$_function1(a){
view3d.core.clear_selectors.call(null);

var pred__12560 = cljs.core._EQ_;
var expr__12561 = cljs.reader.read_string.call(null,a);
if(cljs.core.truth_(pred__12560.call(null,(0),expr__12561))){
return view3d.core.what_is.call(null);
} else {
if(cljs.core.truth_(pred__12560.call(null,(1),expr__12561))){
return view3d.core.where_is.call(null);
} else {
if(cljs.core.truth_(pred__12560.call(null,(2),expr__12561))){
return view3d.core.tell_more.call(null);
} else {
if(cljs.core.truth_(pred__12560.call(null,(3),expr__12561))){
return view3d.core.what_interesting.call(null);
} else {
if(cljs.core.truth_(pred__12560.call(null,(4),expr__12561))){
return view3d.core.weather.call(null);
} else {
if(cljs.core.truth_(pred__12560.call(null,(5),expr__12561))){
...
var vec__12564 = temp__4655__auto__;
var lat = cljs.core.nth.call(null,vec__12564,(0),null);
var lon = cljs.core.nth.call(null,vec__12564,(1),null);
...
view3d.core.repeater.call(null,((function (vec__12564,lat,lon,temp__4655__auto__){
return (function (){
return view3d.core.boat_move.call(null);
});})(vec__12564,lat,lon,temp__4655__auto__))
