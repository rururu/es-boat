...
if(cljs.core.truth_(pred__12386.call(null,"ASTERN",expr__12387))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__12386.call(null,"STARBOARD",expr__12387))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__12386.call(null,"PORT",expr__12387))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__12386.call(null,"STAR-BOW",expr__12387))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__12386.call(null,"PORT-BOW",expr__12387))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__12386.call(null,"STAR-ABAFT",expr__12387))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__12386.call(null,"PORT-ABAFT",expr__12387))){
return (crs - (135));
} else {
return crs;
}
...
var n = cljs.reader.read_string.call(null,a);
var pred__12535 = cljs.core._GT__EQ_;
var expr__12536 = n;
